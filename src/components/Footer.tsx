export default function Footer() {
    return (
      <footer className="border-t border-t-red-500/10 w-full py-4 flex justify-center md:justify-between gap-4 flex-wrap items-center md:px-16 px-8 z-50 duration-250">
        <a href="/">
